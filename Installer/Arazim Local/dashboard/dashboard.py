...
class Button:
    ...
    def draw(self, screen):
        ...
        screen.blit(stat_surf, stat_surf.get_rect(midtop=(self.rect.centerx, self.rect.bottom + 5)))
...
class StatusDisplay:
    ...
    def draw(self, screen, status_text):
        ...
        if status_text == "RUNNING": color = Config.GREEN
        elif status_text == "SLEEPING": color = Config.YELLOW
        else: color = (255, 80, 80) # Light Red
        ...
        screen.blit(lbl_surf, lbl_surf.get_rect(midbottom=(self.rect.centerx, self.rect.top - 5)))
